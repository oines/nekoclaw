export function buildFormationTurnPrompt(input: {
	...
	return [
		...
		"",
		"Prioritize sedimenting these transcript signals when they appear:",
		...
		"- Bot-visible commitments and obligations stated in this run transcript, including promises, agreed follow-ups, and default choices the bot confirmed.",
